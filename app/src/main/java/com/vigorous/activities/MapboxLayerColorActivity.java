...
public class MapboxLayerColorActivity extends AppCompatActivity {

    private MapView mapView;
    private MapboxMap map;
    private FillLayer water;
    private FillLayer building;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapbox_layer_color);
