...
import com.vigorous.testandroideverything.BuildConfig;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnGesture = (Button) findViewById(R.id.btn_gesture);
        mBtnGesture.setOnClickListener(this);
        mBtnMvp = (Button) findViewById(R.id.btn_mvp);
        mBtnMvp.setOnClickListener(this);
        mBtnMapbox = (Button) findViewById(R.id.btn_map_box);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_gesture:
                Intent viiii = new Intent(this,GestureActivity.class);
                startActivity(viiii);
                break;
            case R.id.btn_mvp:
                Intent X = new Intent(this, MvpActivity.class);
                startActivity(X);
                break;
            case R.id.btn_map_box:
                Intent XI = new Intent(this,MapboxActivity.class);
                startActivity(XI);
                break;
