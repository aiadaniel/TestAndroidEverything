...
public class MapboxServiceActivity extends AppCompatActivity {

    private static final String TAG = MapboxServiceActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapbox_service);
    ...
    private void getRoute(Position origin, Position destination) throws ServicesException {
        ...
        client.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(MapboxServiceActivity.this, "Error: " + throwable.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
